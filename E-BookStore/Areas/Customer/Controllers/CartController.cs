...
namespace E_BookStore.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        private double GetPriceBasedOnQuantity(ShoppingCart shoppingCartList)
        {
            if (shoppingCartList.Count == 0)
            {
                return shoppingCartList.Product.Price;
            }
            else
            {
                return shoppingCartList.Product.Price * shoppingCartList.Count;
            }
        }
    }
}
